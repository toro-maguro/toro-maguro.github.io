...
[for文の気持ち](https://toro-maguro.github.io/post/2022-08-09-forlooppython/)の続きです。)
...
想像した通りに動いていました！ただ、これを何回も書くのは非常に読みにくいし冗長なコードになります。**そこで関数化しましょう。** この発想は"Don't Repeat Yourself" というDRY原則に基づきます。
